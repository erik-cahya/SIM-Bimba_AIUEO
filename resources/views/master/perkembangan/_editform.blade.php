<div class="row">
    <div class="form-group">
        ...
        <input class="form-control" id="disabledInput" type="text" placeholder="{{ $data_murid[0]->nama_murid}}" readonly >
    </div>
</div>
...
<div class="row">
    <div class="form-group mt-3">
        ...
        <input type="date" name="tanggal_perkembangan" id="tanggal_perkembangan" class="form-control" value="{{ $perkembangan->tgl_perkembangan }}">
    </div>
</div>
<div class="row">
    <div class="form-group mt-3">
